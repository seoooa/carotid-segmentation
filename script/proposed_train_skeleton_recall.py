...
class CarotidSkeletonSegmentModel(pytorch_lightning.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        if loss_fn_name == "DiceSkeletonRecallLoss":
            if skeleton is None:
                raise ValueError("Skeleton data is required for DiceSkeletonRecallLoss")
...
@click.option(
    "--loss_fn",
    type=click.Choice(["DiceLoss", "DiceCELoss", "DiceFocalLoss", "SkeletonRecallLoss", "DiceSkeletonRecallLoss"]),
    default="DiceSkeletonRecallLoss",
