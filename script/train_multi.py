...
from src.data.dataloader_multi import CarotidDataModule
from src.models.networks_multi import NetworkFactory
...
class CarotidSegmentModel(pytorch_lightning.LightningModule):
    ...
    def __init__(
        ...
        self.post_label = Compose(
            [EnsureType("tensor", device="cpu"), AsDiscrete(to_onehot=6)]
        )
